...
4. Run the Python script (`CriditCardFraudDetection.ipynb`).
...
For deployment in AWS SageMaker, you can use the trained model (`Credit_Card_fraud_detector.pkl`). Follow AWS SageMaker documentation for deploying models and serving predictions.
